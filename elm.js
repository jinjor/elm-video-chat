...
Elm.Lib.Header.make = function (_elm) {
   ...
   var header = function (c) {
      ...
      _L.fromArray([A2($Html.div,
                   ...
                   _L.fromArray([welcomeView(c.user)]))]))]));
   };
...
Elm.Main.make = function (_elm) {
   ...
   var roomDecoder = function () {
      var peer = A4($Json$Decode.object3,
      F3(function (id,name,mail) {
         return {_: {}
                ,id: id
                ,mail: mail
                ,name: name};
   ...
   var Peer = F3(function (a,b,c) {
      return {_: {}
             ,id: a
             ,mail: c
             ,name: b};
   });
   var Room = F2(function (a,b) {
      return {_: {}
             ,id: a
             ,peers: b};
   });
