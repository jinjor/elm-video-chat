...
Elm.Lib = Elm.Lib || {};
Elm.Lib.API = Elm.Lib.API || {};
Elm.Lib.API.make = function (_elm) {
   "use strict";
   _elm.Lib = _elm.Lib || {};
   _elm.Lib.API = _elm.Lib.API || {};
   if (_elm.Lib.API.values)
   return _elm.Lib.API.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   "email",
   $Json$Decode.string));
   var roomDecoder = function () {
      var peer = $Json$Decode.string;
      return A4($Json$Decode.object3,
      F3(function (id,peers,users) {
         return {_: {}
                ,id: id
                ,peers: peers
                ,users: users};
      ...
      A2($Json$Decode._op[":="],
      "peers",
      $Json$Decode.list(peer)),
      A2($Json$Decode._op[":="],
      "users",
      $Json$Decode.keyValuePairs(userDecoder)));
   }();
   var initialRoomsDataDecoder = function () {
      var rooms = $Json$Decode.list(roomDecoder);
      return A3($Json$Decode.object2,
      F2(function (user,rooms) {
         return {_: {}
                ,rooms: rooms
                ,user: user};
      }),
   ...
   var initialDataDecoder = A4($Json$Decode.object3,
   F3(function (user,
   room,
   iceServers) {
      return {_: {}
   ...
   var nocacheGet = F2(function (decoder,
   url) {
      return function () {
         var request = {_: {}
                       ,body: $Http.empty
                       ,headers: _L.fromArray([{ctor: "_Tuple2"
                                               ...
                                               ,_1: "no-cache"}
                                              ,{ctor: "_Tuple2"
                                               ,_0: "If-Modified-Since"
                                               ,_1: "Thu, 01 Jun 1970 00:00:00 GMT"}])
                       ,url: url
                       ,verb: "GET"};
   ...
   var getInitialData = function (roomId) {
      return A2(nocacheGet,
      initialDataDecoder,
      A2($Debug.log,
      "url",
      A2($Basics._op["++"],
   ...
   var InitialRoomsData = F2(function (a,
   b) {
      return {_: {}
             ,rooms: a
             ,user: b};
   });
   var InitialData = F3(function (a,
   b,
   c) {
      return {_: {}
             ,iceServers: c
   ...
   _elm.Lib.API.values = {_op: _op
                         ,InitialData: InitialData
                         ,InitialRoomsData: InitialRoomsData
                         ,Room: Room
                         ,User: User
                         ,nocacheGet: nocacheGet
                         ,getInitialData: getInitialData
                         ,getRooms: getRooms
                         ,initialDataDecoder: initialDataDecoder
                         ,initialRoomsDataDecoder: initialRoomsDataDecoder
                         ,userDecoder: userDecoder
                         ,roomDecoder: roomDecoder};
   return _elm.Lib.API.values;
};
Elm.Lib = Elm.Lib || {};
Elm.Lib.ChatView = Elm.Lib.ChatView || {};
Elm.Lib.ChatView.make = function (_elm) {
   "use strict";
   _elm.Lib = _elm.Lib || {};
   _elm.Lib.ChatView = _elm.Lib.ChatView || {};
   if (_elm.Lib.ChatView.values)
   return _elm.Lib.ChatView.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Lib.ChatView",
   $Basics = Elm.Basics.make(_elm),
   ...
   $Json$Decode = Elm.Json.Decode.make(_elm),
   $List = Elm.List.make(_elm),
   $Native$ChatView = Elm.Native.ChatView.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm),
   $Time = Elm.Time.make(_elm);
   var messageView = F2(function (myName,
   _v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple3":
            return function () {
                 var minute_ = $Basics.toString($Date.minute(_v0._2));
                 var hour_ = $Basics.toString($Date.hour(_v0._2));
                 var time_ = A2($Html.div,
                 _L.fromArray([$Html$Attributes.$class("chat-time")]),
                 _L.fromArray([$Html.text(A2($Basics._op["++"],
                 hour_,
                 A2($Basics._op["++"],
                 ":",
                 minute_)))]));
                 var message_ = A2($Html.div,
                 _L.fromArray([$Html$Attributes.$class("chat-message")]),
                 _L.fromArray([A2($Html.div,
                              _L.fromArray([]),
                              _L.fromArray([$Html.text(_v0._1)]))
                              ,time_]));
                 var name_ = A2($Html.div,
                 _L.fromArray([$Html$Attributes.$class("chat-name")]),
                 _L.fromArray([$Html.text(_v0._0)]));
                 var avator = A2($Html.img,
                 _L.fromArray([$Html$Attributes.src("")
                              ,$Html$Attributes.$class("chat-avator")]),
                 _L.fromArray([]));
                 var self = _U.eq(myName,_v0._0);
                 var clazz = self ? "chat chat-self" : "chat";
                 return A2($Html.li,
                 _L.fromArray([$Html$Attributes.$class(clazz)]),
                 _L.fromArray([avator
                              ,name_
                              ,message_]));
              }();}
   ...
   var chatTimeline = function (model) {
      return A2($Html.ul,
      _L.fromArray([$Html$Attributes.$class("list-unstyled")]),
      A2($List.map,
      function (mes) {
         return A2(messageView,
         model.myName,
         mes);
      },
   ...
   var scrollDown = $Native$ChatView.scrollDown;
   var focus = $Native$ChatView.focus;
   var update = F2(function (action,
   model) {
      return function () {
         var _v7 = A2($Debug.log,
         "ChatView.action",
         action);
         switch (_v7.ctor)
         {case "Close":
            return _U.replace([["opened"
                               ,false]],
              model);
            case "Message":
            return _U.replace([["messages"
                               ,A2($List._op["::"],
                               {ctor: "_Tuple3"
                               ,_0: _v7._0
                               ,_1: _v7._1
                               ,_2: $Date.fromTime(_v7._2)},
                               model.messages)]
                              ,["field",""]
                              ,["noReadCount"
                               ,model.opened ? 0 : model.noReadCount + 1]],
              model);
            case "MyName":
            return _U.replace([["myName"
                               ,_v7._0]],
              model);
            case "Open":
            return _U.replace([["opened"
   ...
   var afterUpdate = function (action) {
      return function () {
         switch (action.ctor)
         {case "Open":
            return A2($Task.onError,
              focus("chat-input"),
              function (s) {
                 return $Task.fail(Error(s));
              });
            case "ScrollDown":
            return A2($Task.onError,
              scrollDown("message-area"),
              function (s) {
                 return $Task.fail(Error(s));
              });}
   ...
   var Open = {ctor: "Open"};
   var closedView = F2(function (address,
   noReadCount) {
      return function () {
         var noreadClass = _U.cmp(noReadCount,
         0) > 0 ? " noread" : "";
         ...
         _L.fromArray([A2($Html.span,
                      _L.fromArray([$Html$Attributes.$class("fa fa-comments")]),
                      _L.fromArray([]))
                      ,$Html.text(A2($Basics._op["++"],
                      "Chat(",
                      A2($Basics._op["++"],
                      $Basics.toString(noReadCount),
                      ")")))]))]);
      }();
   });
   var NoOp = {ctor: "NoOp"};
   var chatInput = F2(function (address,
   field) {
      return A2($Html.input,
      _L.fromArray([$Html$Attributes.id("chat-input")
   ...
   var openedView = F2(function (address,
   model) {
      return _L.fromArray([A2($Html.div,
                          _L.fromArray([$Html$Attributes.$class("panel-heading row")
                                       ,A2($Html$Events.onClick,
                                       address,
                                       Close)]),
                          _L.fromArray([A2($Html.span,
                                       ...
                                       ,$Html.text("Chat")]))
                          ,A2($Html.div,
                          _L.fromArray([$Html$Attributes.id("message-area")
                                       ,$Html$Attributes.$class("panel-body")]),
                          _L.fromArray([chatTimeline(model)]))
                          ,A2($Html.div,
                          _L.fromArray([$Html$Attributes.$class("row")]),
                          _L.fromArray([A2(chatInput,
                          address,
                          model.field)]))]);
   });
   ...
   model) {
      return function () {
         var openedClass = model.opened ? " opened" : "";
         var inner = model.opened ? A2(openedView,
         address,
         model) : A2(closedView,
         address,
         model.noReadCount);
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("chat-view-container container")]),
         _L.fromArray([A2($Html.div,
         _L.fromArray([$Html$Attributes.$class(A2($Basics._op["++"],
         "chat-view panel panel-default col-xs-12 col-sm-8 col-md-6",
         openedClass))]),
         inner)]));
      }();
   });
   _elm.Lib.ChatView.values = {_op: _op
                              ,init: init
                              ,update: update
                              ,view: view
...
Elm.Lib = Elm.Lib || {};
Elm.Lib.Header = Elm.Lib.Header || {};
Elm.Lib.Header.make = function (_elm) {
   "use strict";
   _elm.Lib = _elm.Lib || {};
   _elm.Lib.Header = _elm.Lib.Header || {};
   if (_elm.Lib.Header.values)
   return _elm.Lib.Header.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   _elm.Lib.Header.values = {_op: _op
                            ,Context: Context
                            ,User: User
                            ,header: header
...
Elm.Lib = Elm.Lib || {};
Elm.Lib.PanelHeader = Elm.Lib.PanelHeader || {};
Elm.Lib.PanelHeader.make = function (_elm) {
   "use strict";
   _elm.Lib = _elm.Lib || {};
   _elm.Lib.PanelHeader = _elm.Lib.PanelHeader || {};
   if (_elm.Lib.PanelHeader.values)
   return _elm.Lib.PanelHeader.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Lib.PanelHeader",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm);
   var window = F3(function (header,
   body,
   local) {
      return function () {
         var face = local ? "panel-primary" : "panel-default";
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("col-sm-6 col-md-6")]),
         _L.fromArray([A2($Html.div,
         _L.fromArray([$Html$Attributes.$class(A2($Basics._op["++"],
         "panel ",
         face))]),
         _L.fromArray([header,body]))]));
      }();
   });
   _elm.Lib.PanelHeader.values = {_op: _op
                                 ,window: window};
   return _elm.Lib.PanelHeader.values;
};
Elm.Lib = Elm.Lib || {};
Elm.Lib.VideoControl = Elm.Lib.VideoControl || {};
Elm.Lib.VideoControl.make = function (_elm) {
   "use strict";
   _elm.Lib = _elm.Lib || {};
   _elm.Lib.VideoControl = _elm.Lib.VideoControl || {};
   if (_elm.Lib.VideoControl.values)
   return _elm.Lib.VideoControl.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Lib.VideoControl",
   $Native$VideoControl = Elm.Native.VideoControl.make(_elm),
   $Task = Elm.Task.make(_elm);
   var requestFullScreen = $Native$VideoControl.requestFullScreen;
   _elm.Lib.VideoControl.values = {_op: _op
                                  ,requestFullScreen: requestFullScreen};
   return _elm.Lib.VideoControl.values;
};
Elm.Lib = Elm.Lib || {};
Elm.Lib.WebRTC = Elm.Lib.WebRTC || {};
Elm.Lib.WebRTC.make = function (_elm) {
   "use strict";
   _elm.Lib = _elm.Lib || {};
   _elm.Lib.WebRTC = _elm.Lib.WebRTC || {};
   if (_elm.Lib.WebRTC.values)
   return _elm.Lib.WebRTC.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Lib.WebRTC",
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   $Json$Encode = Elm.Json.Encode.make(_elm),
   $Lib$API = Elm.Lib.API.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Native$WebRTC = Elm.Native.WebRTC.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Set = Elm.Set.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var beforeLeave = $Native$WebRTC.beforeLeave;
   var beforeJoin = $Native$WebRTC.beforeJoin;
   var endStreaming = $Native$WebRTC.endStreaming;
   var startStreaming = $Native$WebRTC.startStreaming;
   var closeRemoteStream = $Native$WebRTC.closeRemoteStream;
   var addCandidate = $Native$WebRTC.addCandidate;
   var acceptAnswer = $Native$WebRTC.acceptAnswer;
   var answerSDP = $Native$WebRTC.answerSDP;
   var initialize = $Native$WebRTC.initialize;
   var onRemoveConnection = $Native$WebRTC.onRemoveConnection;
   var onAddConnection = $Native$WebRTC.onAddConnection;
   var onRemoteVideoURL = function () {
      var f = function (_v0) {
         return function () {
            switch (_v0.ctor)
            {case "_Tuple2":
               return _U.eq(_v0._1,
                 "") ? {ctor: "_Tuple2"
                       ...
                       ,_1: $Maybe.Nothing} : {ctor: "_Tuple2"
                                              ,_0: _v0._0
                                              ,_1: $Maybe.Just(_v0._1)};}
            _U.badCase($moduleName,
            "on line 197, column 23 to 78");
         }();
      };
      return A2($Signal.map,
      f,
      $Native$WebRTC.onRemoteVideoURL);
   }();
   var onLocalVideoURL = function () {
      var f = function (_v4) {
         return function () {
            switch (_v4.ctor)
            {case "_Tuple2":
               return _U.eq(_v4._1,
                 "") ? {ctor: "_Tuple2"
                       ...
                       ,_1: $Maybe.Nothing} : {ctor: "_Tuple2"
                                              ,_0: _v4._0
                                              ,_1: $Maybe.Just(_v4._1)};}
            _U.badCase($moduleName,
            "on line 192, column 28 to 93");
         }();
      };
      return A2($Signal.map,
      f,
      $Native$WebRTC.onLocalVideoURL);
   }();
   var requests = $Native$WebRTC.requests;
   var joinDecoder = function () {
      var userDecoder = A4($Json$Decode.object3,
   ...
   var encoder = function (action) {
      return function () {
         ...
         return $Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                                  ,_0: "type"
                                                  ,_1: $Json$Encode.string(type_)}
                                                 ,{ctor: "_Tuple2"
                                                  ,_0: "from"
                                                  ,_1: $Json$Encode.string(from)}
                                                 ,{ctor: "_Tuple2"
                                                  ,_0: "data"
                                                  ,_1: data_}]));
      }();
      ...
      return function () {
         ...
         {case "AddConnection":
            ...
            return _U.replace([["connections"
              ...
              model);
            case "InitRoom":
            return _U.replace([["peers"
                               ,$Set.fromList(_v26._0)]
                              ,["users"
                               ,$Dict.fromList(_v26._1)]
                              ,["me",_v26._2]],
              model);
            case "Join":
            return _U.replace([["peers"
            ...
            switch (_v26._0.ctor)
              {case "_Tuple2":
                 return _U.replace([["localVideoUrls"
                                    ,function () {
                                       switch (_v26._0._1.ctor)
                                       {case "Just":
                                          return A3($Dict.insert,
                                            _v26._0._0,
                                            _v26._0._1._0,
                                            model.localVideoUrls);
                                          case "Nothing":
   ...
   var Join = F2(function (a,b) {
      return {ctor: "Join"
             ,_0: a
             ,_1: b};
   });
   var EndStream = F2(function (a,
   b) {
      return {ctor: "EndStream"
             ,_0: a
             ,_1: b};
   });
   var AnswerCandidate = F2(function (a,
   b) {
      return {ctor: "AnswerCandidate"
             ,_0: a
             ,_1: b};
   });
   var OfferCandidate = F2(function (a,
   b) {
      return {ctor: "OfferCandidate"
             ,_0: a
             ,_1: b};
   });
   var AnswerSDP = F2(function (a,
   b) {
      return {ctor: "AnswerSDP"
             ,_0: a
             ,_1: b};
   });
   var OfferSDP = F2(function (a,
   b) {
      return {ctor: "OfferSDP"
             ,_0: a
             ,_1: b};
   });
   var convertToAction = F3(function (type_,
   from,
   data_) {
      return _U.eq(type_,
      "offerSDP") ? A2(OfferSDP,
      from,
      data_) : _U.eq(type_,
      "answerSDP") ? A2(AnswerSDP,
      from,
      data_) : _U.eq(type_,
      "offerCandidate") ? A2(OfferCandidate,
      from,
      data_) : _U.eq(type_,
      "answerCandidate") ? A2(AnswerCandidate,
      from,
      data_) : _U.eq(type_,
      "endStream") ? A2(EndStream,
      from,
      data_) : _U.eq(type_,
      "join") ? function () {
         var _v69 = A2($Json$Decode.decodeValue,
         joinDecoder,
         data_);
         switch (_v69.ctor)
         {case "Ok":
            return Join(from)(A2($Debug.log,
              "join",
              _v69._0));}
         return Undefined;
      }() : _U.eq(type_,
      "leave") ? Leave(from) : Undefined;
   });
   var decoder = A4($Json$Decode.object3,
   F3(function (t,f,d) {
      return A3(convertToAction,
      t,
      f,
      d);
   }),
   ...
   var decode = function (s) {
      return function () {
         var _v71 = A2($Json$Decode.decodeString,
         decoder,
         A2($Debug.log,
         "WebRTC.decode",
         s));
   ...
   var EndStreaming = function (a) {
      return {ctor: "EndStreaming"
             ,_0: a};
   };
   var StartStreaming = function (a) {
      return {ctor: "StartStreaming"
             ,_0: a};
   };
   var RemovePeer = function (a) {
      return {ctor: "RemovePeer"
             ,_0: a};
   };
   var InitRoom = F3(function (a,
   b,
   c) {
      return {ctor: "InitRoom"
             ,_0: a
             ,_1: b
             ,_2: c};
   });
   var CloseWindow = function (a) {
      return {ctor: "CloseWindow"
             ,_0: a};
   };
   var RemoveConnection = function (a) {
      return {ctor: "RemoveConnection"
             ,_0: a};
   };
   var AddConnection = function (a) {
      return {ctor: "AddConnection"
             ,_0: a};
   };
   var RemoteVideoUrl = function (a) {
      return {ctor: "RemoteVideoUrl"
             ,_0: a};
   };
   var LocalVideoUrl = function (a) {
      return {ctor: "LocalVideoUrl"
             ,_0: a};
   };
   var actions = $Signal.mergeMany(_L.fromArray([A2($Signal._op["<~"],
                                                LocalVideoUrl,
                                                onLocalVideoURL)
                                                ,A2($Signal._op["<~"],
                                                RemoteVideoUrl,
                                                ...
                                                Request,
                                                requests)]));
   var Initialize = F2(function (a,
   b) {
      return {ctor: "Initialize"
             ,_0: a
             ,_1: b};
   });
   _elm.Lib.WebRTC.values = {_op: _op
                            ,init: init
                            ,update: update
                            ,actions: actions
                            ,doTask: doTask
...
Elm.Lib = Elm.Lib || {};
Elm.Lib.WebSocket = Elm.Lib.WebSocket || {};
Elm.Lib.WebSocket.make = function (_elm) {
   "use strict";
   _elm.Lib = _elm.Lib || {};
   _elm.Lib.WebSocket = _elm.Lib.WebSocket || {};
   if (_elm.Lib.WebSocket.values)
   return _elm.Lib.WebSocket.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Lib.WebSocket",
   $Basics = Elm.Basics.make(_elm),
   $Native$WebSocket = Elm.Native.WebSocket.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var SendError = function (a) {
      return {ctor: "SendError"
             ,_0: a};
   };
   var ConnectionError = function (a) {
      return {ctor: "ConnectionError"
             ,_0: a};
   };
   var logError = function (e) {
      return function () {
         ...
         {case "ConnectionError":
            return e._0;
            case "SendError": return e._0;}
         _U.badCase($moduleName,
         "between lines 25 and 27");
      }();
   };
   var send_ = $Native$WebSocket.send;
   var send = function (mes) {
      return A2($Task.onError,
      send_(mes),
      function (s) {
         return $Task.fail(SendError(s));
      });
   };
   var opened = $Native$WebSocket.opened;
   var message = $Native$WebSocket.message;
   var connect_ = function (s) {
      return $Native$WebSocket.connect(s);
   };
   var connect = function (url) {
      return A2($Task.onError,
      connect_(url),
      function (s) {
         return $Task.fail(ConnectionError(s));
      });
   };
   _elm.Lib.WebSocket.values = {_op: _op
                               ,connect_: connect_
                               ,connect: connect
                               ,message: message
                               ,opened: opened
...
Elm.Main.make = function (_elm) {
   ...
   $Json$Encode = Elm.Json.Encode.make(_elm),
   $Lib$API = Elm.Lib.API.make(_elm),
   $Lib$ChatView = Elm.Lib.ChatView.make(_elm),
   $Lib$Header = Elm.Lib.Header.make(_elm),
   $Lib$VideoControl = Elm.Lib.VideoControl.make(_elm),
   $Lib$WebRTC = Elm.Lib.WebRTC.make(_elm),
   $Lib$WebSocket = Elm.Lib.WebSocket.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Set = Elm.Set.make(_elm),
   ...
   $Task = Elm.Task.make(_elm),
   $Time = Elm.Time.make(_elm);
   var madiaIcon = function (mediaType) {
      return function () {
   ...
   var roomTitle = function (c) {
      return A2($Html.h2,
      _L.fromArray([$Html$Attributes.$class("room-name")]),
      _L.fromArray([$Html.text(c.roomName)]));
   };
   var window = F3(function (header,
   body,
   local) {
   ...
   var windowHeader = F2(function (title,
   buttons) {
      return function () {
         var buttonGroup = A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("header-buttons btn-group pull-right")]),
         buttons);
         return A2($Html.div,
   ...
   var FullScreen = function (a) {
      return {ctor: "FullScreen"
             ,_0: a};
   };
   var fullscreenButton = F2(function (address,
   videoURL) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("btn pull-right")
                   ,A2($Html$Events.onClick,
                   address,
                   FullScreen(videoURL))]),
      _L.fromArray([A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("glyphicon glyphicon-fullscreen")]),
      _L.fromArray([]))]));
   });
   var EndStreaming = function (a) {
      return {ctor: "EndStreaming"
   ...
   var windowCloseButton = F2(function (c,
   mediaType) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("btn pull-right")
                   ,A2($Html$Events.onClick,
                   c.address,
                   EndStreaming({ctor: "_Tuple2"
                                ,_0: mediaType
                                ,_1: $Set.toList(c.rtc.peers)}))]),
      _L.fromArray([A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("glyphicon glyphicon-remove")]),
      _L.fromArray([]))]));
   });
   var mediaWindowView = F5(function (c,
   mediaType,
   title,
   videoUrl,
   local) {
      return function () {
         var buttons = local ? _L.fromArray([A2(windowCloseButton,
                                            c,
                                            mediaType)
                                            ,A2(fullscreenButton,
                                            c.address,
                                            videoUrl)]) : _L.fromArray([A2(fullscreenButton,
         c.address,
         videoUrl)]);
         var videoHtml = A2($Html.video,
         _L.fromArray([$Html$Attributes.src(videoUrl)
                      ,A2($Html$Attributes.attribute,
                      "autoplay",
                      "")]),
         _L.fromArray([]));
         return A3(window,
         A2(windowHeader,title,buttons),
         videoHtml,
         local);
      }();
   });
   var localMediaWindowView = F3(function (address,
   c,
   mediaType) {
      return function () {
         var maybeVideoUrl = A2($Dict.get,
         mediaType,
         c.rtc.localVideoUrls);
         var title = A2($Basics._op["++"],
         "Local ",
         mediaType);
         return A2($Maybe.map,
         function (videoUrl) {
            return A5(mediaWindowView,
            c,
            mediaType,
            title,
            videoUrl,
   ...
   var madiaButton = F2(function (c,
   mediaType) {
      return function () {
         var peers = $Set.toList(c.rtc.peers);
         ...
         var action = streaming ? EndStreaming({ctor: "_Tuple2"
                                               ,_0: mediaType
                                               ,_1: peers}) : StartStreaming({ctor: "_Tuple2"
                                                                             ,_0: mediaType
                                                                             ,_1: peers});
         var classes = function () {
            switch (mediaType)
         ...
         _L.fromArray([$Html$Attributes.type$("button")
                      ...
                      c.address,
                      action)]),
         _L.fromArray([madiaIcon(mediaType)]));
      }();
   });
   var InitRoom = function (a) {
      return {ctor: "InitRoom"
             ,_0: a};
   };
   ...
   var ChatMessage = F3(function (a,
   b,
   c) {
      return {ctor: "ChatMessage"
             ,_0: a
             ,_1: b
             ,_2: c};
   });
   var ChatAction = function (a) {
      return {ctor: "ChatAction"
             ,_0: a};
   };
   var RTCAction = function (a) {
      return {ctor: "RTCAction"
             ,_0: a};
   };
   var NoOp = {ctor: "NoOp"};
   var actions = $Signal.mailbox(NoOp);
   var userOf = F2(function (c,
   peerId) {
      return function () {
         var _v4 = A2($Dict.get,
         peerId,
   ...
   context) {
      return function () {
         var _v6 = A2($Debug.log,
         "action",
         action);
         switch (_v6.ctor)
         {case "ChatAction":
            return _U.replace([["chat"
                               ,A2($Lib$ChatView.update,
                               _v6._0,
                               context.chat)]],
              context);
            case "ChatMessage":
            return _U.replace([["chat"
                               ,A2($Lib$ChatView.update,
                               A3($Lib$ChatView.Message,
                               A2(userOf,context,_v6._0).name,
                               _v6._1,
                               _v6._2),
                               context.chat)]],
              context);
            case "EndStreaming":
            return _U.replace([["rtc"
                               ,A2($Lib$WebRTC.update,
                               $Lib$WebRTC.EndStreaming(_v6._0),
                               context.rtc)]],
              context);
            case "Init":
            return _U.replace([["selfPeerId"
                               ,_v6._0]
                              ,["roomName",_v6._1]],
              context);
            case "InitRoom":
            return _U.replace([["rtc"
                              ...
                              ,["chat"
                               ,A2($Lib$ChatView.update,
                               $Lib$ChatView.MyName(_v6._0.user.name),
                               context.chat)]],
              context);
            case "RTCAction":
            return _U.replace([["rtc"
            ...
            return _U.replace([["rtc"
                               ,A2($Lib$WebRTC.update,
                               $Lib$WebRTC.StartStreaming(_v6._0),
                               context.rtc)]],
              context);}
         return context;
      }();
   });
   var peerView = F3(function (address,
   c,
   peer) {
      return function () {
         var user = A2(userOf,c,peer);
         return A2($Html.li,
         _L.fromArray([]),
         _L.fromArray([A2($Html.div,
         _L.fromArray([]),
         _L.fromArray([A2($Html.i,
                      _L.fromArray([$Html$Attributes.$class("fa fa-user")]),
                      _L.fromArray([]))
                      ,$Html.text(user.name)]))]));
      }();
   });
   var peerViews = F3(function (address,
   c,
   peers) {
      return A2($Html.ul,
      _L.fromArray([$Html$Attributes.$class("user-list list-unstyled hidden-xs")]),
      A2($List.map,
      function (peer) {
         return A3(peerView,
         address,
   ...
   var remoteMediaWindowView = F3(function (address,
   c,
   connection) {
      return function () {
         var maybeVideoUrl = A2($Dict.get,
         ...
         peerId = $._0,
         mediaType = $._1;
         var user = A2(userOf,c,peerId);
         var title = $String.concat(_L.fromArray([user.name]));
         return A2($Maybe.map,
         function (videoUrl) {
            return A5(mediaWindowView,
            c,
   ...
   var mediaViews = function (c) {
      return function () {
         var remoteList = A2($List.map,
         function (connection) {
            return A3(remoteMediaWindowView,
            c.address,
            c,
            connection);
         },
         $Set.toList(c.rtc.connections));
         var localList = A2($List.map,
         function (mediaType) {
            return A3(localMediaWindowView,
            c.address,
            c,
            mediaType);
         },
         _L.fromArray(["video"
                      ,"screen"]));
         var both = $List.concat(_L.fromArray([localList
                                              ,remoteList]));
         var filterd = A2($List.filter,
         function (maybe) {
            return function () {
               switch (maybe.ctor)
               {case "Just": return true;
   ...
   var mainView = function (c) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("col-sm-9 col-md-9")]),
      _L.fromArray([A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("row")]),
      mediaViews(c))]));
   };
   var messageDecoder = A3($Json$Decode.object2,
   F2(function (v0,v1) {
      return {ctor: "_Tuple2"
             ,_0: v0
             ,_1: v1};
   ...
   "time",
   $Json$Decode.$float));
   var chatMessagedecoder = A4($Json$Decode.object3,
   F3(function (t,f,_v22) {
      return function () {
         switch (_v22.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple3"
   ...
   "data",
   messageDecoder));
   var decodeChatMessage = function (s) {
      return function () {
         ...
         switch (_v26.ctor)
         {case "Ok":
            return $Maybe.Just(_v26._0);}
         return $Maybe.Nothing;
      }();
   };
   var decode = function (s) {
      return function () {
         var _v28 = $Lib$WebRTC.decode(s);
         switch (_v28.ctor)
         {case "Just":
            return RTCAction(_v28._0);
            case "Nothing":
            return function () {
                 var _v30 = decodeChatMessage(s);
                 switch (_v30.ctor)
                 {case "Just":
                    switch (_v30._0.ctor)
                      {case "_Tuple3":
                         return A3(ChatMessage,
                           _v30._0._0,
                           _v30._0._1,
                           _v30._0._2);}
                      break;
   ...
   var actionSignal = $Signal.mergeMany(_L.fromArray([actions.signal
                                                     ,A2($Signal._op["<~"],
                                                     decode,
                                                     $Lib$WebSocket.message)
                                                     ,A2($Signal._op["<~"],
                                                     RTCAction,
                                                     $Lib$WebRTC.actions)]));
   var joinToJson = F2(function (selfId,
   roomName) {
      return function () {
         var value = $Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                                       ,_0: "room"
                                                       ,_1: $Json$Encode.string(roomName)}
                                                      ,{ctor: "_Tuple2"
                                                       ,_0: "from"
                                                       ,_1: $Json$Encode.string(selfId)}
                                                      ,{ctor: "_Tuple2"
                                                       ,_0: "type"
                                                       ,_1: $Json$Encode.string("join")}]));
         return A2($Json$Encode.encode,
         0,
         value);
      }();
   });
   var messageToJson = F4(function (selfId,
   roomName,
   mes,
   time) {
      return function () {
         var value = $Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                                      ...
                                                      ,{ctor: "_Tuple2"
                                                       ...
                                                       ,_1: $Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                                                                              ,_0: "message"
                                                                                              ,_1: $Json$Encode.string(mes)}
                                                                                             ,{ctor: "_Tuple2"
                                                                                              ,_0: "time"
                                                                                              ,_1: $Json$Encode.$float(time)}]))}]));
         return A2($Json$Encode.encode,
         0,
         value);
      }();
   });
   var signalToJson = F3(function (selfId,
   roomName,
   _v35) {
      return function () {
         switch (_v35.ctor)
         {case "_Tuple3":
            return function () {
                 var value = $Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                                              ...
                                                              ,{ctor: "_Tuple2"
                                                               ,_0: "to"
                                                               ,_1: $Json$Encode.string(_v35._1)}
                                                              ,{ctor: "_Tuple2"
                                                               ,_0: "type"
                                                               ,_1: $Json$Encode.string(_v35._0)}
                                                              ,{ctor: "_Tuple2"
                                                               ,_0: "data"
                                                               ,_1: _v35._2}]));
                 return A2($Json$Encode.encode,
   ...
   var errorLog = function (e) {
      return function () {
         ...
         {case "ChatViewError":
            ...
            return "fetch error";
            case "RTCError":
            return $Lib$WebRTC.logError(e._0);
            case "VideoControlError":
            return "VideoControlError";
            case "WSError":
   ...
   var RTCError = function (a) {
      return {ctor: "RTCError"
             ,_0: a};
   };
   var initializeRTC = F2(function (selfPeerId,
   initial) {
      return A2($Task.onError,
      $Lib$WebRTC.doTask(A2($Lib$WebRTC.Initialize,
      selfPeerId,
      initial.iceServers)),
      function (e) {
   ...
   var ChatViewError = function (a) {
      return {ctor: "ChatViewError"
             ,_0: a};
   };
   var WSError = function (a) {
      return {ctor: "WSError"
             ,_0: a};
   };
   ...
   var fetchRoom = function (roomId) {
      return A2($Task.onError,
      $Lib$API.getInitialData(roomId),
      function (err) {
   ...
   runner);
   var errorLogRunner = Elm.Native.Task.make(_elm).performSignal("errorLogRunner",
   A2($Signal.map,
   function (task) {
      return A2($Task.onError,
      task,
      function (e) {
         return $Task.fail($Debug.log("error: ")(errorLog(e)));
      });
   },
   taskRunner));
   var initialContext = {_: {}
                        ,address: actions.address
                        ,chat: $Lib$ChatView.init
                        ,roomName: ""
                        ,rtc: $Lib$WebRTC.init
                        ,selfPeerId: ""};
   var context = A3($Signal.foldp,
   update,
   initialContext,
   actionSignal);
   ...
   function () {
            ...
            {case "_Tuple2":
               return function () {
                    ...
                    {case "ChatAction":
                       ...
                       case "ChatMessage":
                       return A2($Task.onError,
                         $Lib$ChatView.afterUpdate($Lib$ChatView.ScrollDown),
                         function (e) {
                            return $Task.fail(ChatViewError(e));
                         });
                       case "EndStreaming":
                       ...
                       case "InitRoom":
                       return A2($Task.onError,
                         $Lib$WebSocket.send(A2(joinToJson,
                         c.selfPeerId,
                         c.roomName)),
                         function (e) {
                            return $Task.fail(WSError(e));
      ...
      f,
      $Time.timestamp(actionSignal),
      context);
   }());
   var mediaTypes = _L.fromArray(["mic"
                                 ,"video"
                                 ,"screen"]);
   var mediaButtons = F2(function (address,
   c) {
      return A2($Html.div,
   ...
   var statusView = function (c) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("col-sm-3 col-md-3")]),
      _L.fromArray([A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("status-panel row panel panel-default")]),
      _L.fromArray([A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("panel-body")]),
      _L.fromArray([roomTitle(c)
                   ,A2(mediaButtons,c.address,c)
                   ,A3(peerViews,
                   c.address,
                   c,
                   $Set.toList(c.rtc.peers))]))]))]));
   };
   var view = function (c) {
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([$Lib$Header.header({_: {}
                                       ,user: {_: {}
                                              ,name: c.rtc.me.name}})
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("container")]),
                   _L.fromArray([statusView(c)
                                ,mainView(c)
                                ,A2($Lib$ChatView.view,
                                A2($Signal.forwardTo,
                                c.address,
                                ChatAction),
                                c.chat)]))]));
   ...
   _elm.Main.values = {_op: _op
                      ...
                      ,errorLog: errorLog
                      ,signalToJson: signalToJson
                      ,messageToJson: messageToJson
                      ,joinToJson: joinToJson
                      ...
                      ,localMediaWindowView: localMediaWindowView
                      ,remoteMediaWindowView: remoteMediaWindowView
                      ,mediaWindowView: mediaWindowView
                      ,main: main};
   return _elm.Main.values;
};
Elm.Maybe = Elm.Maybe || {};
