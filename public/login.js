...
Elm.Main.make = function (_elm) {
   ...
   model) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("login-wrapper")]),
      _L.fromArray([A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("panel panel-default center-block")
      ...
      _L.fromArray([A2($Html.div,
                   ...
                   _L.fromArray([$Html.text("please login")]))]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("panel-body")]),
                   _L.fromArray([A2($Html.form,
                   _L.fromArray([$Html$Attributes.$class("form-horizontal col-md-12")
                                ,$Html$Attributes.action("/api/login")
                                ,$Html$Attributes.method("POST")]),
                   _L.fromArray([A2($Html.div,
                                _L.fromArray([$Html$Attributes.$class("form-group row")]),
                                _L.fromArray([A2($Html.label,
                                             _L.fromArray([$Html$Attributes.$class("col-sm-2 control-label")]),
                                             _L.fromArray([$Html.text("Mail")]))
                                             ,A2($Html.div,
                                             _L.fromArray([$Html$Attributes.$class("col-sm-10")]),
                                ...
                                _L.fromArray([A2($Html.input,
                                _L.fromArray([$Html$Attributes.$class("login-submit btn btn-primary")
